...
Press `U` or `Backspace` to undo your last move.

When the game ends, a "Game Over" screen will appear. You can press `R` to restart or `U` to undo the last move and continue playing.
